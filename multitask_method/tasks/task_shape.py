...
from multitask_method.tasks.utils import accumulate_rotation, accumulate_scaling
...
class DeformedHypershapePatchMaker(PatchShapeMaker):
    ...
    def make_shape_intersect_function(self, inv_trans_matrix: npt.NDArray[float], trans_matrix: npt.NDArray[float],
